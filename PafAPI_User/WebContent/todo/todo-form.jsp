...
<body>
	<header>
		<nav class="navbar navbar-expand-md navbar-dark"
			...
			<div>
				<a href="https://www.javaguides.net" class="navbar-brand"> User Managment APP</a>
			</div>
		...
		<div class="card">
			<div class="card-body">
				...
				<fieldset class="form-group">
					<label>AccountNo</label> <input type="text"
				...
				<fieldset class="form-group">
					<label>TDate of Payment</label> <input type="date"
